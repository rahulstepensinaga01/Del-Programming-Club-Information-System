                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <?= form_open_multipart('Admin/TambahModul') ?>
                                            <form action="" method=" post">
                                                <div class="form-group">
                                                    <label for="judul_modul">Nama Modul</label>
                                                    <input type="text" Name="judul_upload" class="form-control" placeholder="Masukkan nama Modul...">
                                                </div>
                                                <div class="form-group">
                                                    <label for="isi_modul">Deskripsi Modul</label>
                                                    <textarea Name="isi_upload" class="form-control" placeholder="Masukkan Deskripsi..."></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_upload">File Pendukung</label>
                                                    <input type="file" Name="nama_upload" class="form-control" placeholder="Masukkan judul Modul...">
                                                </div>
                                                <a href="<?= base_url(); ?>Admin/DaftarAnggota" class="btn btn-danger">Kembali</a>
