...
<body id="page-top">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Modul <strong>Berhasil</strong>.
    ...
    <?php if ($this->session->flashdata('edit')) : ?>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Edit Modul <strong>Berhasil</strong>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/Modul') ?>">
                        ...
                        <div class="">
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="carimodul" class="form-control bg-light border-0 small" placeholder="Cari Modul..." aria-label="Search" aria-describedby="basic-addon2">
                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-group">
                                                <?php foreach ($Modul as $Gota) : ?>
                                                    <li class="list-group-item">
                                                        <p>Nama Modul : <?= $Gota['judul_upload']; ?></p>
                                                        <p>Deskripsi : <?= $Gota['isi_upload']; ?></p>
                                                        <a href="<?= base_url(); ?>Admin/Hapusmodul/<?= $Gota['id_upload']; ?>" class="badge badge-danger bg-danger  float-right" onclick="return confirm('Anda yakin?');">Hapus</a>
                                                        <a href="<?= base_url(); ?>Admin/edit_modul/<?= $Gota['id_upload']; ?>" class="badge badge-primary bg-primary float-right">Edit</a>
                                                        <a href="<?= base_url(); ?>Admin/download/<?= $Gota['id_upload']; ?>" class="badge badge-primary bg-info float-right"><i class="fas fa-download"></i></a>
                                                    </li>

                                                <?php endforeach; ?>
                                                <br>
                                                <a href="<?= base_url('Admin/TambahModul') ?>"><i class="fas fa-plus"></i> Tambah Modul</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
