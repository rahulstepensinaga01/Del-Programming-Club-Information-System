        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/Tutorial') ?>">
                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <ul class="list-group">
                                                <form action="<?= base_url('Admin/update_modul'); ?>" method="post">
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Nama Modul</label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" name="id_peng" class="form-control" value="<?= $id_upload['id_upload']; ?>">
                                                            <input type="text" name="judul_upload" class="form-control-plaintext" id="staticEmail" value="<?= $id_upload['judul_upload'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Deskripsi</label>
                                                        <div class="col-sm-10">
                                                            <textarea name="isi_upload" class="form-control-plaintext" id="staticEmail"><?= $id_upload['isi_upload'] ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">URL Download</label>
                                                        <div class="col-sm-10">
                                                            <textarea name="nama_upload" class="form-control-plaintext" id="staticEmail"><?= $id_upload['nama_upload'] ?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <a class="btn btn-danger" href="<?= base_url('admin/Modul'); ?>">Kembali</a>
                                                </form>
                                            </ul>
                                        </div>
                                    </div>
