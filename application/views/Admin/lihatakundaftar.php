...
<body id="page-top">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Pendaftar <strong>Berhasil</strong>.
    ...
    <?php if ($this->session->flashdata('edit')) : ?>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Edit Data Pendaftar <strong>Berhasil</strong>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/lihatakundaftar') ?>">
                        ...
                        <div class="">
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="carianggota" class="form-control bg-light border-0 small" placeholder="Cari Pendaftar..." aria-label="Search" aria-describedby="basic-addon2">
                                                ...
                                                <?php foreach ($Anggota as $Gota) : ?>
                                                    ...
                                                    ?>
                                                        <li class="list-group-item"><?= $Gota['nama']; ?>
                                                            <a href="<?= base_url(); ?>Admin/Hapus/<?= $Gota['nim']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin nih?');">Hapus</a>
                                                            <a href="<?= base_url(); ?>Admin/edit_anggota/<?= $Gota['nim']; ?>" class="badge badge-primary float-right">Edit</a>
                                                            <a href="<?= base_url(); ?>Admin/Detailregister/<?= $Gota['nim']; ?>" class="badge badge-primary float-right">Detail</a>
                                                        </li>
                                                    <?php } ?>
                                                <?php endforeach; ?>
                                            </ul>
