        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/DaftarKomentar') ?>">
                            <i class="fas fa-calendar-week"></i> <span>Komentar Anggota</span>
                        </a>
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <!--custom chart end-->
                        <div class="">
                            <form action="<?= base_url('Admin/carikomentar') ?>" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="carikomentar" class="form-control bg-light border-0 small" placeholder="Cari Komentar..." aria-label="Search" aria-describedby="basic-addon2">
                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-group">
                                                <?php foreach ($komen as $Gota) : ?>
                                                    <li class="list-group-item">
                                                        <p>Asal Komentar : <?= $Gota['judul_modul']; ?></a></p>
                                                        <p>Dari : <?= $Gota['nama_komentar']; ?></p>
                                                        <p>Komentar : <?= $Gota['isi_komentar']; ?></a></p>
                                                        <a href="<?= base_url(); ?>Admin/Hapuskomentar/<?= $Gota['id_komentar']; ?>" class="badge badge-danger bg-danger float-right" onclick="return confirm('Anda yakin?');">Hapus</a>
                                                    </li>
