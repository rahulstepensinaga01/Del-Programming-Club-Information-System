        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered"><a href="<?= base_url('Anggota/edit'); ?>"><i width="80" class="fas fa-user-circle img-circle"></i></a></p>
                    <h5 class="centered"><?= $user['nama']; ?></h5>
                    <li class="mt">
                        <a href="<?= base_url('Anggota/halaman_anggota'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Anggota/DaftarAnggota') ?>">
                            <i class="fas fa-users"></i> <span>Lihat Anggota</span>
                        </a>

                    </li>
                    <li class="sub-menu">
                        <a href="<?= base_url('Anggota/Tutorial') ?>">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            <a href="#" class="list-group-item list-group-item-action active bg-info">
                                                Detail <b style="color: black; font-family : 'Calibri';"><?= $Anggota['nama'] ?></b> :
                                            </a>
                                            <ul class="list-group">
                                                <p class="btn btn-muted">Data anggota</p>
                                                ...
                                                <li class="list-group-item"><b>Prodi : </b><?= $Anggota['prodi']; ?></li>
                                                <li class="list-group-item"><b>Angkatan : </b><?= $Anggota['angkatan']; ?></li>

                                                <li class="list-group-item"><b>Motivasi : </b><?= $Anggota['motivasi']; ?></li>
                                                <a href="<?= base_url('Admin/DaftarAnggota'); ?>" class="btn btn-info active">Kembali</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
