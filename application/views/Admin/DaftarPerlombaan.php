        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Perlombaan <strong>Berhasil</strong>.
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <!--custom chart end-->
                        <div class="">
                            <form action="<?= base_url('Admin/cariperlombaan') ?>" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="cariperlombaan" class="form-control bg-light border-0 small" placeholder="Cari Perlombaan..." aria-label="Search" aria-describedby="basic-addon2">
                                            ...
                                            <ul class="list-group">
                                                <?php foreach ($perlombaan as $Gota) : ?>
                                                    <li class="list-group-item">
                                                        ...
                                                        <p>URL : <a href="<?= $Gota['isi_perlombaan']; ?>">Ikuti <?= $Gota['isi_perlombaan']; ?></a></p>
                                                        <a href="<?= base_url(); ?>Admin/Hapusperlombaan/<?= $Gota['id_perlombaan']; ?>" class="badge badge-danger bg-danger float-right" onclick="return confirm('Anda yakin?');">Hapus</a>
                                                    </li>

                                                <?php endforeach; ?>
                                                <br><br>
                                                <br><a href="<?= base_url('Admin/TambahPerlombaan') ?>"><i class="fas fa-plus"></i> Tambah Perlombaan</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
