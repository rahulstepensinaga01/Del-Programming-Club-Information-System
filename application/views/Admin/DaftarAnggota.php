...
<body id="page-top">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Anggota <strong>Berhasil</strong>.
    ...
    <?php if ($this->session->flashdata('edit')) : ?>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Edit Data Anggota <strong>Berhasil</strong>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="">
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="carianggota" class="form-control bg-light border-0 small" placeholder="Cari anggota..." aria-label="Search" aria-describedby="basic-addon2">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            <a href="#" class="list-group-item list-group-item-action active bg-info">
                                                Anggota Del Programming Club
                                            </a>
                                            <ul class="list-group">
                                                <?php foreach ($Anggota as $Gota) : ?>
                                                    <?php if ($Gota['role_id'] != 3) { ?>
                                                        <li class="list-group-item"><?= $Gota['nama']; ?>
                                                            <a href="<?= base_url(); ?>Admin/Hapus/<?= $Gota['nim']; ?>" class="badge badge-danger bg-danger float-right" onclick="return confirm('Yakin nih?');">Hapus</a>
                                                            <a href="<?= base_url(); ?>Admin/edit_anggota/<?= $Gota['nim']; ?>" class="badge badge-primary bg-primary float-right">Edit</a>
                                                            <a href="<?= base_url(); ?>Admin/Detail/<?= $Gota['nim']; ?>" class="badge badge-info bg-info float-right">Detail</a>
                                                        </li>
                                                    <?php } ?>
                                                <?php endforeach; ?>
                                            </ul>
