                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php if (validation_errors()) : ?>
                                                <div class="alert alert-info" role="alert">
                                                    <?= validation_errors(); ?>
                                                </div <?php endif; ?> <form action="<?= base_url('Admin/TambahTools'); ?>" method="post">
                                                <div class="form-group">
                                                    <label for="nama_tools">Nama Tools</label>
                                                    <input type="text" Name="nama_tools" class="form-control" placeholder="Masukkan nama tools...">
                                                </div>
                                                <div class="form-group">
                                                    <label for="isi_tools">Link Donwload Tools</label>

                                                    <input type="text" class="form-control" placeholder="Masukkan URL.." name="isi_tools">
                                                </div>

                                                <a href="<?= base_url(); ?>Admin/DaftarTools" class="btn btn-danger">Kembali</a>
