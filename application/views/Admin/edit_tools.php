                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <ul class="list-group">
                                                <form action="<?= base_url('Admin/update_tools'); ?>" method="post">
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Nama Tools</label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" name="id_tools" class="form-control" value="<?= $id_tools['id_tools']; ?>">
                                                            <input type="text" name="nama_tools" class="form-control-plaintext" id="staticEmail" value="<?= $id_tools['nama_tools'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">URL Tools</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="isi_tools" class="form-control-plaintext" id="staticEmail" value="<?= $id_tools['isi_tools'] ?>">

                                                        </div>
                                                    </div>

                                                    <button type="submit" class="btn btn-primary">Simpan</button>
                                                    <a class="btn btn-danger" href="<?= base_url('Admin/DaftarTools'); ?>">Batal</a>
                                                </form>
                                            </ul>
                                        </div>
                                    </div>
