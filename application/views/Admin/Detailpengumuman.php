        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered"><a href="<?= base_url('Admin/edit'); ?>"><i width="80" class="fas fa-user-circle img-circle"></i></a></p>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="message-p pn">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            <ul class="list-group">
                                                <p class="btn btn-muted">Detail Pengumuman</p>
                                                <li class="list-group-item"><b>
                                                        <center><?= $pengumuman['judul_pengumuman']; ?></center>
                                                    </b></li>
                                                <li class="list-group-item">
                                                    <p><?= $pengumuman['isi_pengumuman']; ?></p>
                                                    <?= $pengumuman['tempat_pengumuman'] ?>, <?= $pengumuman['waktu_pengumuman'] ?>
                                                </li>

                                                <a href="<?= base_url('Admin/lihatpengumuman'); ?>" class="btn btn-info active">Kembali</a>
