...
<body id="page-top">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Tools <strong>Berhasil</strong>.
    ...
    <?php if ($this->session->flashdata('edit')) : ?>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Edit Tools <strong>Berhasil</strong>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/DaftarTools') ?>">
                        ...
                        <div class="">
                            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="caritools" class="form-control bg-light border-0 small" placeholder="Cari Tools..." aria-label="Search" aria-describedby="basic-addon2">
                                ...
                                <div class="message-p pn">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-group">
                                                <?php foreach ($tools as $Gota) : ?>
                                                    <li class="list-group-item">
                                                        <p>Nama Tools : <?= $Gota['nama_tools']; ?></p>
                                                        <p>URL : <a href="<?= $Gota['isi_tools']; ?>"><?= $Gota['isi_tools']; ?></a></p>

                                                        <a href="<?= $Gota['isi_tools']; ?>" class="btn btn-info float-right"><i class="fas fa-download"></i></a>
                                                        <a href="<?= base_url(); ?>Admin/Hapus_tools/<?= $Gota['id_tools']; ?>" class="btn btn-danger float-right" onclick="return confirm('Yakin nih?');">Hapus </a>
                                                        <a href="<?= base_url(); ?>Admin/edit_tools/<?= $Gota['id_tools']; ?>" class="btn btn-primary float-right">Edit </a>
                                        ...
                                        <a href="<?= base_url('Admin/TambahTools'); ?>" class=" btn btn-info float-right"> <i class="fas fa-plus"></i>
                                            Tambah Tools </a>
                                    </div>
                                </div>
                            </div>
