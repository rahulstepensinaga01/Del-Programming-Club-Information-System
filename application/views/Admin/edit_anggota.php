        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Komentar <strong>Berhasil</strong>.
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered"><a href="#"><i width="80" class="fas fa-user-circle img-circle"></i></a></p>
                    <h5 class="centered"><?= $user['nama']; ?></h5>
                    <li class="mt">
                        <a href="<?= base_url('Admin/halaman_anggota'); ?>">
                            <i class="fa fa-dashboard"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/DaftarAnggota') ?>">
                    ...
                    <li class="sub-menu">
                        <a href="<?= base_url('Admin/DaftarPerlombaan') ?>">
                            <i class="fas fa-calendar-week"></i> <span>Events</span>
                        </a>

                    </li>
                    <li class="sub-menu">
                        <a href="<?= base_url('Admin/DaftarKomentar') ?>">
                            <i class="fas fa-comments"></i> <span>Komentar Anggota</span>
                        </a>
                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <ul class="list-group">
                                                <form action="<?= base_url('Admin/update_anggota'); ?>" method="post">
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">NIM</label>
                                                        <div class="col-sm-10">
                                                            <input type="hidden" name="id" class="form-control" value="<?= $nim['user_id']; ?>">
                                                            <input type="text" name="nim" class="form-control-plaintext" id="staticEmail" value="<?= $nim['nim'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Nama</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nama" class="form-control-plaintext" id="staticEmail" value="<?= $nim['nama'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                                        <div class="col-sm-10">
                                                            <input type="email" name="email" class="form-control-plaintext" id="staticEmail" value="<?= $nim['email'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Password</label>
                                                        <div class="col-sm-10">
                                                            <input type="password" name="password" class="form-control-plaintext" id="staticEmail" value="<?= $nim['password'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Confirm Password</label>
                                                        <div class="col-sm-10">
                                                            <input type="password" name="password2" class="form-control-plaintext" id="staticEmail" value="<?= $nim['password'] ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="angkatan" class="form-control-plaintext" id="staticEmail" value="<?= $nim['angkatan'] ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="role_id" class="form-control-plaintext" id="staticEmail" value="<?= $nim['role_id'] ?>">
                                                            <button type="submit" class="btn btn-primary">Simpan</button>
                                                            <a class="btn btn-danger" href="<?= base_url('admin/DaftarAnggota'); ?>">Kembali</a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </ul>
