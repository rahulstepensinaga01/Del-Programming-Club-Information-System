                                ...
                                <div class="message-p">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-group">
                                                <p class="btn btn-muted">Data Pendaftar</p>
                                                ...
                                                <a href="<?= base_url('Admin/lihatakundaftar'); ?>" class="btn btn-info active">Kembali</a><br>
                                                <!-- <a href="<?= base_url(); ?>Admin/Hapus/<?= $Anggota['nim']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin nih?');">Hapus</a> -->
