                                            ...
                                            <ul class="list-group">
                                                <form action="<?= base_url('Admin/update_pengumuman'); ?>" method="post">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="hidden" name="id_peng" class="form-control" value="<?= $id_peng['id_peng']; ?>">
                                                            <input type="text" name="judul_pengumuman" class="form-control-plaintext" id="staticEmail" value="<?= $id_peng['judul_pengumuman'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Isi Pengumuman : </label>
                                                        <div class="col-sm-10">
                                                            <textarea name="isi_pengumuman" class="form-control-plaintext" id="staticEmail"><?= $id_peng['isi_pengumuman'] ?></textarea>
                                                        </div>
                                                    </div>
                                                    <br><br>
                                                    <div class="form-group">
                                                        <label for="judul_pengumuman">Waktu & Tempat pengumuman : </label>

                                                        <input type="date" class="form-control" name="waktu_pengumuman" value="<?= $id_peng['waktu_pengumuman'] ?>"> <br>
                                                        <input type="text" class="form-control" placeholder="Masukkan tempat.." name="tempat_pengumuman" value="<?= $id_peng['tempat_pengumuman'] ?>">
                                                    </div>
                                                    ...
                                                    <a class="btn btn-danger" href="<?= base_url('admin/lihatpengumuman'); ?>">Kembali</a>
                                                </form>
                                            </ul>
                                        </div>
