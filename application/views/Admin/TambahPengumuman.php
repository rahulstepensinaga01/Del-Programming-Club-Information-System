                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php if (validation_errors()) : ?>
                                                <div class="alert alert-info" role="alert">
                                                    <?= validation_errors(); ?>
                                                </div <?php endif; ?> <form action="<?= base_url('Admin/TambahPengumuman'); ?>" method="post">
                                                <div class="form-group">
                                                    <label for="id_pengumuman">Judul Pengumuman</label>
                                                    <input type="text" Name="judul_pengumuman" class="form-control" id="id_pengumuman" placeholder="Masukkan judul pengumuman...">
                                                </div>
                                                <div class="form-group">
                                                    <label for="judul_pengumuman">Waktu & Tempat pengumuman</label>

                                                    <input type="date" class="form-control" name="waktu_pengumuman"> <br>
                                                    <input type="text" class="form-control" placeholder="Masukkan tempat.." name="tempat_pengumuman">
                                                </div>
                                                <div class="form-group">
                                                    <label for="isi_pengumuman">isi pengumuman</label>
                                                    <textarea Name="isi_pengumuman" class="form-control" id="isi_pengumuman" placeholder="Masukkan isi pengumuman..."></textarea>
                                                </div>
                                                <a href="<?= base_url(); ?>Admin/lihatpengumuman" class="btn btn-danger">Kembali</a>
