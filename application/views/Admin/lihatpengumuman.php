...
<body id="page-top">
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Hapus Pengumuman <strong>Berhasil</strong>.
    ...
    <?php if ($this->session->flashdata('edit')) : ?>
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Edit Pengumuman <strong>Berhasil</strong>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Admin/lihatpengumuman') ?>">
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <!--custom chart end-->
                        <div class="">
                            <form action="<?= base_url('Admin/caripengumuman') ?>" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                <div class="input-group">
                                    <input type="text" name="caripengumuman" class="form-control bg-light border-0 small" placeholder="Cari Pengumuman..." aria-label="Search" aria-describedby="basic-addon2">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            <a href="#" class="list-group-item list-group-item-action active bg-info">
                                                Daftar Pengumuman Del Programming Club
                                            </a>
                                            <ul class="list-group">
                                                <?php foreach ($pengumuman as $Gota) : ?>
                                                    <li class="list-group-item"><?= $Gota['judul_pengumuman']; ?>
                                                        <a href="<?= base_url(); ?>Admin/Hapuspengumuman/<?= $Gota['id_peng']; ?>" class="badge badge-danger bg-danger float-right" onclick="return confirm('Anda yakin?');">Hapus</a>
                                                        <a href="<?= base_url(); ?>Admin/edit_pengumuman/<?= $Gota['id_peng']; ?>" class="badge badge-primary bg-primary float-right">Edit</a>
                                                        <a href="<?= base_url(); ?>Admin/Detail_Pengumuman/<?= $Gota['id_peng']; ?>" class="badge badge-primary bg-info float-right">Detail</a>
                                                    </li>

                                                <?php endforeach; ?>
                                                <br>
                                                <a href="<?= base_url('Admin/TambahPengumuman') ?>"><i class="fas fa-plus"></i> Tambah Pengumuman</a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
