        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div>
                        <img src="<?= base_url('assets') ?>/img/asido.jpg" alt="" style="width: 200px; height :300px;">
                    </div>
                    <div class="contents">
                        <h2><a href="#">Asido Agripo Panjaitan</a></h2>
                        <p class="mb-3">11319002
                        </p>
                        <p class="mb-3"><a href="https://www.instagram.com/asidopanjaitan_/"><i class="fab fa-instagram"> instagram.com/asidopanjaitan_</a></i>
                        </p>
                ...
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div>
                        <img src="<?= base_url('assets') ?>/img/rahul.jpeg" alt="" style="width: 200px; height :300px;">
                    </div>
                    <div class="contents">
                        <h2><a href="#">Rahul Stepen Sinaga</a></h2>
                        <p class="mb-3">11319023
                        </p>
                        <p class="mb-3"><a href="https://www.instagram.com/rahul.sinaga01/"><i class="fab fa-instagram"> instagram.com/rahul.sinaga01</a></i>
                        </p>
                ...
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div>
                        <img src="<?= base_url('assets') ?>/img/priskila.jpeg" alt="" style="width: 200px; height :300px;">
                    </div>
                    <div class="contents">
                        <h2><a href="#">Priskila Apriliana Nababan</a></h2>
                        <p class="mb-3">11319041
                        </p>
                        <p class="mb-3"><a href="https://www.instagram.com/priskila.nbbn/"><i class="fab fa-instagram"> instagram.com/priskila.nbbn</a></i>
                        </p>
                ...
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div>
                        <img src="<?= base_url('assets') ?>/img/madelin.jpeg" alt="" style="width: 200px; height :300px;">
                    </div>
                    <div class="contents">
                        <h2><a href="#">Madelin Panjaitan</a></h2>
                        <p class="mb-3">11319036
                        </p>
                        <p class="mb-3"><a href="https://www.instagram.com/madelin_panjaitan/"><i class="fab fa-instagram"> instagram.com/madelin_panjaitan</a></i>
                        </p>
