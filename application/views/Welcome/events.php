...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('<?= base_url('assets') ?>/template/images/test.jpg')"></div>
                    <div class="contents">
                        <h2><a href="#">Testing Penerimaan anggota baru</a></h2>
                        <p class="mb-3">Testing ini bertujuan untuk menyeleksi seluruh mahasiswa/mahasiswi yang ingin bergabung
                            ke dalam Delpro apakah serius atau tidak melalui tes.
                            Soal-soal yang diujikan mengenai dasar-dasar pemrograman.
                        </p>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    ...
                    <div class="contents">
                        <h2><a href="#">Sosialisasi</a></h2>
                        <p class="mb-3">Sosialisasi ini bertujuan untuk mengenalkan UKM Delpro kepada seluruh mahasiswa/i IT DEL
                            dan juga untuk memberikan solusi kepada mahasiswa/i yang memiliki minat dan bakat untuk dikembangkan dalam <i>programming</i>
                        </p>
