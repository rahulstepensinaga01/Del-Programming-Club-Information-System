...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="site-wrap">
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image:url('<?= base_url('assets') ?>/template/images/acm.png')"></div>
                    <div class="contents">
                        <h2><a href="#">Finalis ACMICPC pada tahun 2016</a></h2>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('<?= base_url('assets') ?>/template/images/blackchinnese.jpeg')"></div>
                    <div class="contents">
                        <h2><a href="#">ACMICPC Maranatha pada tahun 2019</a></h2>
                        <p class="mb-3"><br><br><br>
                        </p>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('<?= base_url('assets') ?>/template/images/contoh.jpg')"></div>
                    <div class="contents">
                        <h2><a href="#">Kompetisi Maranatha pada tahun 2019</a></h2>
                        <p class="mb-3"><br><br><br>
                        </p>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    ...
                    <div class="contents">
                        <h2><a href="#">Jakarta ACMICPC pada tahun 2019</a></h2>
                        <p class="mb-3"><br><br><br>
                        </p>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('<?= base_url('assets') ?>/template/images/acmicpc.jpg')"></div>
                    <div class="contents">
                        <h2><a href="#">Finalis Mikroskil pada tahun 2019</a></h2>
                        <p class="mb-3"><br><br><br>
                        </p>
        ...
        <div class="site-section">
            <div class="container">
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    <div class="img-bg" style="background-image: url('<?= base_url('assets') ?>/template/images/gemastik.jpg')"></div>
                    <div class="contents">
                        <h2><a href="#">Gemastik Universitas Telkom</a></h2>
                        <p class="mb-3"><br><br><br>
                        </p>
