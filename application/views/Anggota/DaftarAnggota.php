                                                ...
                                                <?php foreach ($Anggota as $Gota) : ?>
                                                    <?php if ($Gota['role_id'] != 3) { ?>
                                                        <li class="list-group-item"><?= $Gota['nama']; ?>
                                                            <!-- <a href="<?= base_url(); ?>Welcome/Hapus/<?= $Gota['nim']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin nih?');">Hapus</a> -->
                                                            <a href="<?= base_url(); ?>Anggota/Detail/<?= $Gota['nim']; ?>" class="btn btn-info float-right">Detail</a></li>
                                                    <?php } ?>
                                                <?php endforeach; ?>
                                            </ul>
                                        </div>
