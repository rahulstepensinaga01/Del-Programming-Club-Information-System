        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <div class="alert alert-success " role="alert">
                    Komentar anda sudah <strong>Terkirim :)</strong>.
        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Anggota/lihattutorial') ?>">
                                                    ...
                                                    <li class="list-group-item">
                                                        ...
                                                        <form method="post" action="<?= base_url('Anggota/TambahKomentar') ?>">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="judul_modul" value="Modul <?= $Gota['judul_upload']; ?>" hidden>
                                                        ...
                                                        <a href="<?= base_url(); ?>Admin/download/<?= $Gota['id_upload']; ?>" class="btn btn-primary bg-info float-right">Unduh disini <i class="fas fa-download"></i></a>
                                                    </li>
