        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Anggota/DaftarTools') ?>">
                                            ...
                                            <ul class="list-group">
                                                <?php foreach ($tools as $Gota) : ?>
                                                    <li class="list-group-item">
                                                        ...
                                                        <p>URL Download : <a href="<?= $Gota['isi_tools']; ?>"> <?= $Gota['isi_tools']; ?></a></p>
                                                    </li>

                                                <?php endforeach; ?>
                                                <a href="<?= base_url(); ?>Anggota" class="btn bg-info" style="color: white;"><i class="fas fa-long-arrow-alt-left"></i></a>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
