                                                ...
                                                <form action="<?= base_url('Anggota/update'); ?>" method="post">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input type="text" name="nama" class="form-control-plaintext" id="staticEmail" value="<?= $user['nama'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">NIM</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="nim" class="form-control-plaintext" id="staticEmail" value="<?= $user['nim'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Email</label>
                                                        <div class="col-sm-10">
                                                            <input type="email" name="email" class="form-control-plaintext" id="staticEmail" value="<?= $user['email'] ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="inputPassword" class="col-sm-2 col-form-label">Password</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="password" class="form-control" id="inputPassword" value="<?= $user['password']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <small class="text-danger"><?= form_error('prodi'); ?></small> </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label for="staticEmail" class="col-sm-2 col-form-label">Ganti/Tambah foto profile</label>
                                                        <div class="col-sm-10">
                                                            <input type="file" name="foto" class="form-control-plaintext" id="staticEmail" value="<?= $user['foto'] ?>">
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i></button>
                                                    <a class="btn btn-danger" href="<?= base_url('Anggota/halaman_anggota'); ?>"><i class="fas fa-long-arrow-alt-left"></i></a>
                                                </form>
                                            </ul>
                                        </div>
                                    </div>
