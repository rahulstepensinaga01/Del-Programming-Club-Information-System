        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Anggota/lihatpengumuman') ?>">
                                                    ...
                                                    <div class="list-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <ul class="list-group">
                                                                ...
                                                                <?php foreach ($pengumuman2 as $Gota) : ?>
                                                                    <li class="list-group-item"><?= $Gota['judul_pengumuman']; ?>
                                                                        <a href="<?= base_url(); ?>Anggota/DetailPengumuman/<?= $Gota['id_peng']; ?>" class="badge badge-primary bg-info float-right">Detail</a>
                                                                    </li>
