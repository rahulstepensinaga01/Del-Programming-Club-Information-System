                                        ...
                                        <div class="col-md-12">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold text-primary">
                                                    <center><b><?= $pengumuman['judul_pengumuman']; ?></b></center>
                                                </h6>
                                            </div>
                                            <div class="card-body">

                                                <div><?= $pengumuman['isi_pengumuman']; ?></div>
                                            </div>
                                            <h6 class="m-0 font-weight-bold text-primary">
                                                <b><?= $pengumuman['tempat_pengumuman']; ?></b>,
                                                <b><?= $pengumuman['waktu_pengumuman']; ?></b>
                                            </h6>
                                            <br><br>
                                            <center><a href="<?= base_url('Anggota/lihatpengumuman'); ?>" class="btn btn-primary"><i class="fas fa-long-arrow-alt-left"></i></a>
                                            </center>
                                        </div>
                                    </div>
                                </div>
