        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active" href="<?= base_url('Anggota/DaftarPerlombaan') ?>">
            ...
            <section class="wrapper">
                <div class="row">
                    <div class="col-lg-12 main-chart">
                        ...
                        <!--custom chart end-->
                        <div class="">
                            <form action="<?= base_url('Anggota/cariperlombaan') ?>" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="post">
                                    ...
                                    <div class="list-group">
                                        <div class="col-md-12">
                                            <a href="#" class="list-group-item list-group-item-action active bg-info">
                                                Daftar Perlombaan yang dapat anda ikuti :
                                            </a>
                                            <ul class="list-group">
